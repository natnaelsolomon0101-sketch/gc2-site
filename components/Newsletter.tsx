...
export default function Newsletter() {
  ...
  return (
    <section className="band border-t border-stone">
      <div className="wrap">
        <div className="mx-auto max-w-[600px] text-center">
          <p className="eyebrow">Newsletter</p>
          <h2 className="tiempos t-h mt-6">{NEWSLETTER.heading}</h2>
          <form onSubmit={(e) => { e.preventDefault(); if (email) setSent(true); }}
            ...
            <input id="nl-email" type="email" required value={email}
                   ...
                   className="w-full rounded-full border border-graphite-ink bg-transparent py-[10px] pl-5 pr-[10px] text-[14px] text-paper-white outline-none placeholder:text-pebble sm:w-[320px]" />
            <Button type="submit" variant="primary" size="md" className="w-full sm:w-auto">{NEWSLETTER.cta}</Button>
          </form>
          <p aria-live="polite" className="mt-5 text-[14px] text-pebble">
